      ...
      <div class="col-span-3">
        ...
        <div class="w-full h-max mt-6">
          <div class="flex items-center mb-2 h-full py-3 gap-4">
            ...
            <img src="../assets/images/image1.jpg" class="h-[80px] rounded-sm" alt="" />
            <div class="w-[50%] ms-3 h-[80px]">
              <span class="block text-xs mb-2 font-bold">Baju Kaos Murah Terjangkau</span>
              <span class="block text-xs mb-2 font-bold">Color: <span class="text-slate-500 ms-2">Red</span></span>
              <span class="block text-xs font-bold">Quantity: <span class="text-slate-500 ms-2">1</span></span>
            </div>
            <span class="text-xs">Rp. 200.000</span>
            <div class="text-end w-[20%]">
              <button class="bg-purple-500 px-3 py-2 text-xs text-slate-50 rounded-md">Add to cart</button>
            </div>
          </div>
          <div class="flex items-center mb-2 h-full py-3 gap-4">
            <i class="bx text-xl bx-x"></i>
            <img src="../assets/images/image2.jpg" class="h-[80px] rounded-sm" alt="" />
            <div class="w-[50%] ms-3 h-[80px]">
              <span class="block text-xs mb-2 font-bold">Baju Kaos Murah Terjangkau</span>
              <span class="block text-xs mb-2 font-bold">Color: <span class="text-slate-500 ms-2">Red</span></span>
              <span class="block text-xs font-bold">Quantity: <span class="text-slate-500 ms-2">1</span></span>
          ...
          <div class="flex items-center mb-2 h-full py-3 gap-4">
            <i class="bx text-xl bx-x"></i>
            <img src="../assets/images/image3.jpg" class="h-[80px] rounded-sm" alt="" />
            <div class="w-[50%] ms-3 h-[80px]">
              <span class="block text-xs mb-2 font-bold">Baju Kaos Murah Terjangkau</span>
              <span class="block text-xs mb-2 font-bold">Color: <span class="text-slate-500 ms-2">Red</span></span>
              <span class="block text-xs font-bold">Quantity: <span class="text-slate-500 ms-2">1</span></span>
